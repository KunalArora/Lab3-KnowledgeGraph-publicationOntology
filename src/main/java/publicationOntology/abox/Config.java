...
public class Config {
    ...
    public static final String AUTHOR_UNIVERSITY_PATH = "src/main/resources/author_with_review.csv";
    public static final String PAPER_PATH = "src/main/resources/papers.csv";
